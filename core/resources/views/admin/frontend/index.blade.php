                                ...
                                @foreach($section->element as $k => $type)
                                    @if($k !='modal')
                                        @if($type=='text' || $type=='icon')
                                            <th scope="col">{{ __(inputTitle($k)) }}</th>
                                        @elseif($k == 'select')
                                            <th scope="col">{{inputTitle(@$section->element->$k->name)}}</th>
                                        @endif
                                    @endif
                                @endforeach
                                    ...
                                    @foreach($section->element as $k => $type)
                                        @if($k !='modal')
                                            ...
                                            @elseif($k == 'select')
                                                ...
                                                @endphp
                                                <td data-label="{{__(inputTitle(@$section->element->$k->name))}}">{{@$data->data_values->$dataVal}}</td>
                                            @endif
                                        @endif
                                    @endforeach
